package com.betterprojectsfaster.opensource.springboot.nativethumbnails;
...
public class NativethumbnailsApplication implements CommandLineRunner {

  public static void main(String[] args) {
    SpringApplication.run(NativethumbnailsApplication.class, args);
  }
  ...
  public void run(String... args) throws Exception {
    try {
      System.out.println();
      System.out.println("************************************");
      System.out.println("*   ALL THUMBS Spring Boot 1.0.0   *");
      System.out.println("************************************");
      System.out.println();
